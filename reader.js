...
root.innerHTML = `<div id="vreader-scroller"> <div id="vreader-body"></div> </div> <div id="vreader-end"> <div class="vr-end-title"></div> <div class="vr-end-ads"></div> <nav class="vr-end-nav"></nav> <div class="vr-end-tip"></div> </div> <div id="vreader-bar"> <button data-act="font-dec">a−</button> <button data-act="font-inc">A＋</button> <button data-act="theme">配色</button> <button data-act="exit">×</button> </div> <div id="vreader-info"></div> <div id="vreader-loading">読み込み中…</div>`;
...
#vreader-body ruby { display: inline; }
#vreader-body rt { font-size: .5em; line-height: 1; }
